...
<div class="left-panel">
  ...
  <div class="hero-text">
    ...
    <p>For reserving rooms, managing resources, and keeping the school running smoothly.</p>
  </div>
...
<div class="right-panel">
  <div class="login-card">
    <p class="greeting"><img src="assets/img/help-logo.png" style="width:50px; height:50px;" alt=" Logo"> HELP International School</p>
    ...
    <form method="POST" action="includes/login_handler.php">
     ...
     <div class="divider"><span>or sign in with Google</span></div>

   <!-- GOOGLE SIGN IN -->
    <a href="includes/google_auth_login.php" class="btn-google">
    ...
    <div class="admin-link-row">
      <p>Are you an administrator? <a href="adminlogin.php">Admin Login →</a></p>
    </div>
